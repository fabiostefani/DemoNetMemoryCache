...
{
    public class CategoriaCachingDecorator<T> : ICategoriaRepositorioQuery
    where T : ICategoriaRepositorioQuery
    {
        ...
        public async Task<Categoria> ObterPorId(Guid id)
        {
            ...
            Categoria categoria;
            if (!_memoryCache.TryGetValue(keyMemoryCacheProdutoPorId, out categoria))
            {
                ...
                _memoryCache.Set(keyMemoryCacheProdutoPorId, categoria, cacheOptions);
